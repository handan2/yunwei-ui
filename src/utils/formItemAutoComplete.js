...
//console.log('formValidate',props)
   ...
   // const chooseUser = props.userInfo
    ...
    const idUserMiji = data4['计算机详细信息表.责任人密级']||data4['计算机信息表.责任人密级']
    const idUserName = data4['计算机详细信息表.责任人']||data4['计算机信息表.责任人']//如果表单里没有此项也不会报错
    const idDept = data4['计算机详细信息表.责任部门']|| data4['计算机信息表.责任部门']
